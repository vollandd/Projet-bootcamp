  ...
  <div class="col-8">
    ...
    <div class="col-12 offset-1 mt-5">
        <table class="table table-bordered">
            ...
            ?>
                        <tr>
                          <td class="text-center"><?php echo $stock->getType();?></td>
